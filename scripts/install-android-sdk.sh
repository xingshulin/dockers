...
echo y | android-sdk-linux/tools/android -s update sdk --no-ui --filter build-tools-24.0.3,build-tools-23.0.3,build-tools-21.1.2,android-24,android-23,android-22,android-21 -a
